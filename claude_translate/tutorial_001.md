---
title: "1. Pythonを始めたくなる理由"
chapter: 1
section: "Python基礎"
prev_chapter: null
next_chapter: 2
exam_weight: "高"
key_concepts: ["Python特徴", "用途", "他言語比較", "モジュール化", "インタープリタ言語"]
estimated_time: "30分"
---
...
### 🎯 試験頻出ポイント
- **Pythonの特徴**: インタープリタ言語、高レベルデータ型、モジュール化
- **他言語との比較**: C/C++/Javaとの違い、シェルスクリプトとの違い
- **コードの特徴**: インデントでブロック表現、型宣言不要
- **拡張性**: C言語での拡張が可能

### 💡 覚えておくべきキーワード
- **インタープリタ言語**: コンパイル不要で即実行可能
- **高レベルデータ型**: リスト、辞書が標準装備
- **モジュール**: プログラムの部品化と再利用
- **マルチプラットフォーム**: Windows、macOS、Unix対応
- **バッテリー同梱**: 豊富な標準ライブラリ

### ⚡ よくある間違い
- **「Pythonは遅い」**: 開発速度とプロトタイピングでは圧倒的に有利
- **「型がない」**: 動的型付けだが型は存在する
- **「簡単すぎる」**: シンプルな構文だが本格的なプログラムが書ける

---

**次の章**: [2. Pythonインタープリタの使い方](tutorial_002.md)